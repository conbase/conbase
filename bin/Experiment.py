...
fibs_path = '/media/box2/Experiments/Marez/conbase/results/female_final.json'
tcell_path = '/media/box2/Experiments/Marez/conbase/results/fibs/fibs_29juli_wo4243.json'
...
for dp in dp_range:
    for internal_ratio in internal_ratio_range:
        for external_ratio in external_ratio_range:
            p = mp.Process(target=run_bash_code, args=(test_path, dp, internal_ratio, external_ratio, dataset_name, queue))
            jobs.append(p)
            p.start()
